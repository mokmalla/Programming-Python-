...
print()
print("시작값 2.5 이상 끝값 10.0 미만 실수값")
print("random.uniform(2.5, 10.0) : ", random.uniform(2.5, 10.0))
print()
print("100 이상 999 이하 정수 값")
print("random.radint(100, 999) : ", random.randint(100, 999)) #100 이상 999이하
print()
#random.randrange(100, 999) 100이상 999미만 정수random값
...
print("섞은 후 1=",l)
print()
print("리스트에서 몇 개의 값을 중복하지 ㅇ낳고 3개 뽑기")
